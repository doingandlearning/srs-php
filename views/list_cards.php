...
<table>
	...
	<?php foreach ($cards as $card) : ?>
		...
		<tr>
			...
			<td>
				<?php if ($userCard) : ?>
					Last Reviewed: <?= $userCard['last_reviewed'] ? htmlspecialchars($userCard['last_reviewed']) : 'Not yet reviewed' ?><br>
			...
			<td>
				<?php if (!$userCard) : ?>
					<a href="/controllers/CardController.php?action=addToUserList&card_id=<?= $card['id'] ?>">Add to my list</a>
				<?php endif; ?>
			</td>
		</tr>
	<?php endforeach; ?>
